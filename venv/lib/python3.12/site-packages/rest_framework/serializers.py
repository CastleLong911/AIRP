    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def get_uniqueness_extra_kwargs(self, field_names, declared_fields, extra_kwargs):
        ...
        for (
            ...
            condition_fields,
            condition,
        ) in self.get_unique_together_constraints(model):
            unique_together_list_and_condition_fields = set(unique_together_list) | set(
                condition_fields
            )
    ...
    def get_unique_together_validators(self):
        ...
        for (
            ...
            condition_fields,
            condition,
        ) in self.get_unique_together_constraints(self.Meta.model):
            # Skip if serializer does not map to all unique together sources
            unique_together_and_condition_fields = set(unique_together) | set(
                condition_fields
            )

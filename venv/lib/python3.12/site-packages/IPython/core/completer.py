...
from traitlets import DottedObjectName, Enum, Int
...
if sys.version_info < (3, 12):
    from typing_extensions import NotRequired, Protocol, TypeAlias, TypedDict, TypeGuard
else:
    from typing import NotRequired, Protocol, TypeAlias, TypedDict, TypeGuard
